== 7. Deployment and Update Strategy (.NET Core Model)

=== 7.1 Wide-Open Update Palette
...
=== 7.2 Supported Update Methods

==== 7.2.1 Enterprise Distribution (SCCM, Intune, etc.)
...
=== 7.5 Deployment Workflow Example
